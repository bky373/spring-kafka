...
public class AsyncMonoFutureRetryTopicClassLevelIntegrationTests {
	...
	static class SixthTopicDefaultDLTListener {
		...
		public Mono<Void> listenNoDlt(
			...
			return Mono.error(new IllegalStateException("Another woooops... " + receivedTopic))
					.doAfterTerminate(() -> container.countDownIfNotKnown(receivedTopic, container.countDownLatch6))
					.then();
		}
