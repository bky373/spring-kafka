...
public class AsyncCompletableFutureRetryTopicClassLevelIntegrationTests {
	...
	static class SecondTopicListener {
		...
		@KafkaHandler
		public CompletableFuture<Void> listenAgain(String message,
	...
	static class ThirdTopicListener {
		...
		@KafkaHandler
		public CompletableFuture<Void> listenWithAnnotation(String message,
				@Header(KafkaHeaders.RECEIVED_TOPIC) String receivedTopic) {
	...
	static class FifthTopicListener2 extends AbstractFifthTopicListener {
		...
		@KafkaHandler
		public CompletableFuture<Void> listenWithAnnotation2(String message,
				@Header(KafkaHeaders.RECEIVED_TOPIC) String receivedTopic) {
	...
	static class NoRetryTopicListener {
		...
		@KafkaHandler
		public CompletableFuture<Object> listenWithAnnotation2(String message,
				@Header(KafkaHeaders.RECEIVED_TOPIC) String receivedTopic) {
	...
	static class FirstReuseRetryTopicListener {
		...
		@KafkaHandler
		public CompletableFuture<Void> listen1(String message,
				@Header(KafkaHeaders.RECEIVED_TOPIC) String receivedTopic) {
	...
	static class SecondReuseRetryTopicListener {
		...
		@KafkaHandler
		public CompletableFuture<Void> listen2(String message,
				@Header(KafkaHeaders.RECEIVED_TOPIC) String receivedTopic) {
	...
	static class ThirdReuseRetryTopicListener {
		...
		@KafkaHandler
		public CompletableFuture<Void> listen3(String message,
				@Header(KafkaHeaders.RECEIVED_TOPIC) String receivedTopic) {
